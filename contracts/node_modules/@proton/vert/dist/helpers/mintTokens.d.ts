 ...
 */
export declare const mintTokens: (contract: Account, symbol: string, precision: number, maxSupply: number, amountToMintToEach: number, accountsToMintTo: Account[]) => Promise<void>;
